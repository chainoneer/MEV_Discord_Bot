...
class Collectibles:
  ...
  def __init__(self):
    self.__agents={"Astra":False, "Breach":False, "Brimstone":False, "Chamber":False, "Cypher":False,"Jett":False, "KAY/O":False, "Killjoy":False, "Neon":False, "Omen":False, "Phoenix":False, "Raze":False, "Reyna":False, "Sage":False, "Skye":False, "Sova":False,  "Viper":False, "Yoru":False}
...
async def on_message(message):
  ...
  if message.content.startswith('$startnew'):
    ...
    if new_user == True:
      ...
      db[message.author] = Collectibles()
